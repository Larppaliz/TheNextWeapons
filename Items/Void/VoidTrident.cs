...
{
    public class VoidTrident : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.autoReuse = true;
            Item.mana = 5;
            Item.shoot = ModContent.ProjectileType<Projectiles.VoidTrident>();
            Item.shootSpeed = 5f;
        }
        ...
        {
            if ((int)player.Distance(Main.MouseWorld) + 20f > Projectiles.VoidTrident.HoldoutRangeMax) { Item.reuseDelay = (int)Projectiles.VoidTrident.HoldoutRangeMax / 5; }
            else
            {
