...
namespace TheNextWeapons.Items.Ranged.Gems
{
    public class EmeraldBow : ModItem
    {
        ...
        {
            // DisplayName.SetDefault("Emerald Longbow");
            // Tooltip.SetDefault("");
        }
        public override void SetDefaults()
        {
            ...
            Item.value = 4000; // How much the Item is worth, in copper coins, when you sell it to a merchant. It costs 1/5th of this to buy it back from them. An easy way to remember the value is platinum, gold, silver, copper or PPGGSSCC (so this Item price is 10gold)
	    ...
	    Item.crit = 8;
            ...
            Item.useTime = 37;     //How fast the Weapon is used.
            Item.useAnimation = 37;    //How long the Weapon is used for.
        ...
        public override void AddRecipes()
        {
            ...
            recipe2.AddIngredient(ItemID.Emerald, 10);
            recipe2.AddIngredient(ItemID.TungstenBow, 1);
