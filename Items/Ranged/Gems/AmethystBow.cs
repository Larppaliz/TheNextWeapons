...
namespace TheNextWeapons.Items.Ranged.Gems
{
    public class AmethystBow : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.value = 400; // How much the Item is worth, in copper coins, when you sell it to a merchant. It costs 1/5th of this to buy it back from them. An easy way to remember the value is platinum, gold, silver, copper or PPGGSSCC (so this Item price is 10gold)
	    ...
	    Item.crit = 8;
            ...
            Item.useTime = 41;     //How fast the Weapon is used.
            Item.useAnimation = 41;    //How long the Weapon is used for.
        ...
        public override void AddRecipes()
        {
            ...
            recipe2.AddIngredient(ItemID.Amethyst, 10);
            recipe2.AddIngredient(ItemID.CopperBow, 1);
